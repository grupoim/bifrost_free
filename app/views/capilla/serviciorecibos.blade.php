...
<div class="col-md-4">
	...
	<div class="widget">
		<div class="widget-head">
			<div class="pull-left ">Datos del cliente <a href="{{action('ClienteControlador@getEdit', $venta->cliente_id)}}" name="id" value="{{{$venta->id}}}"  title="Detalles" class="btn btn-xs btn-default"><i class="fa fa-pencil"> </i> </a> </div>
			<div class="widget-icons pull-right">
