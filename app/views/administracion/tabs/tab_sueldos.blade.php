 ...
 <div @if ($tab=='tab1' or $tab == '') class="tab-pane fade in active"@else class="tab-pane fade" @endif id="sueldos">
                        <p><!-- Matter -->
 ...
 <div class="widget">
               ...
               <div align="left"> Sueldo e impuesto de nomina</div>    
                  <div class="clearfix"></div>
                </div>
                <div class="widget-content">
                <div class="padd">
         {{ Form::open(array('action' => 'ReporteMensualControlador@postSueldo','class' => 'form-horizontal', 'role' => 'form', 'id'=>'empresa','files' => true)) }} 
                ...
                <div class="form-group" >
                  ...
                  <div class="form-group" id="div_monto" >
                     ...
                     <div class="col-lg-10" align="right">
                            <label class="radio-inline" ><input type="radio" name="insercion"  value="1" id="individual" >Monto individual - Nuevo </label>
                            <label class="radio-inline"><input type="radio" name="insercion" value="0" id="conjunto">Montos en conjunto</label>
                     </div>
                     ...
                     <div  class="form-group" id="div_sueldo_impuesto2">

                              @foreach($gastos as $g)
                              @if($g->sueldo_impuesto == 1)
