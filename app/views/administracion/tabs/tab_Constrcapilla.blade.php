 ...
 <div @if ($tab=='tab5' or $tab == 'edit_tab5') class="tab-pane fade in active"@else class="tab-pane fade" @endif id="Ccapilla">
                        <p><!-- Matter -->
 ...
 <div class="widget">
               ...
               <div align="left"> Gastos de construcción de capilla</div>    
                  <div class="clearfix"></div>
                </div>
                <div class="widget-content">
                <div class="padd">
         {{ Form::open(array('action' => 'ReporteMensualControlador@postGConstrcapilla','class' => 'form-horizontal', 'role' => 'form', 'id'=>'empresa','files' => true)) }} 
                ...
                <div class="form-group" >
                  ...
                  <div class="form-group" id="div_monto5" >
                     ...
                     <div class="col-lg-10" align="right">
                            <label class="radio-inline" ><input type="radio" name="insercion5"  value="1" id="individual5" >Monto individual - Nuevo </label>
                            <label class="radio-inline"><input type="radio" name="insercion5" value="0" id="conjunto5">Montos en conjunto</label>
                     </div>
                     ...
                     <div  class="form-group" id="div_gasto_const_capilla2">

                              @foreach($gastos as $g)
                              @if($g->gasto_constr_capilla == 1)
