 ...
 <div @if ($tab=='tab5' or $tab == 'edit_tab5') class="tab-pane fade in active"@else class="tab-pane fade" @endif id="cartera">
                        <p><!-- Matter -->
 <div class="col-md-5">  
    @if($status=='created')
 ...
 <div class="widget">
               ...
               <div align="left"> Cartera clientes</div>    
                  <div class="clearfix"></div>
                </div>
                <div class="widget-content">
                <div class="padd">
         {{ Form::open(array('action' => 'ReporteMensualControlador@postCartera','class' => 'form-horizontal', 'role' => 'form', 'id'=>'empresa','files' => true)) }} 
                ...
                <div class="form-group" >
                  ...
                  <div class="form-group" >
                      <label class="col-lg-3 control-label"><strong>Monto </strong></label>
	                    ...
	                    <div class="form-group">
                          <label class="col-lg-3 control-label">P. Cartera</label>
                                <div class="col-lg-8">
                                   <select class="form-control ventas chosen-select" name="cartera_id" id="cartera_id">
                                     <option value="0">Seleccione</option>
