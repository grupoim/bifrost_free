 ...
 <div @if ($tab=='tab3' or $tab == 'edit_tab3') class="tab-pane fade in active"@else class="tab-pane fade" @endif id="operacion">
                        <p><!-- Matter -->
 ...
 <div class="widget">
               ...
               <div align="left"> Gastos de operación</div>    
                ...
                <div class="padd">
         {{ Form::open(array('action' => 'ReporteMensualControlador@postGoperacion','class' => 'form-horizontal', 'role' => 'form', 'id'=>'empresa','files' => true)) }} 
                ...
                <div class="form-group" >
                  ...
                  <div class="form-group" id="div_monto3" >
                     ...
                     <div class="col-lg-10" align="right">
                            <label class="radio-inline" ><input type="radio" name="insercion3"  value="1" id="individual3" >Monto individual - Nuevo </label>
                            <label class="radio-inline"><input type="radio" name="insercion3" value="0" id="conjunto3">Montos en conjunto</label>
                     </div>
                     ...
                     <div  class="form-group" id="div_gasto_operacion2">

                              @foreach($gastos as $g)
                              @if($g->gasto_operacion == 1)
