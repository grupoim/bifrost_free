 ...
 <div @if ($tab=='tab2' or $tab == 'edit_tab2') class="tab-pane fade in active"@else class="tab-pane fade" @endif id="admon">
                        <p><!-- Matter -->
 ...
 <div class="widget">
               ...
               <div align="left"> Gastos de administración</div>    
                  <div class="clearfix"></div>
                </div>
                <div class="widget-content">
                <div class="padd">
         {{ Form::open(array('action' => 'ReporteMensualControlador@postGadmon','class' => 'form-horizontal', 'role' => 'form', 'id'=>'empresa','files' => true)) }} 
                ...
                <div class="form-group" >
                  ...
                  <div class="form-group" id="div_monto2" >
                     ...
                     <div class="col-lg-10" align="right">
                            <label class="radio-inline" ><input type="radio" name="insercion2"  value="1" id="individual2" >Monto individual - Nuevo </label>
                            <label class="radio-inline"><input type="radio" name="insercion2" value="0" id="conjunto2">Montos en conjunto</label>
                     </div>
                     ...
                     <div  class="form-group" id="div_gasto_admon2">
