 ...
 <div @if ($tab=='tab4' or $tab == 'edit_tab4') class="tab-pane fade in active"@else class="tab-pane fade" @endif id="Mcapilla">
                        <p><!-- Matter -->
 ...
 <div class="widget">
               ...
               <div align="left"> Gastos de operación</div>    
                  <div class="clearfix"></div>
                </div>
                <div class="widget-content">
                <div class="padd">
         {{ Form::open(array('action' => 'ReporteMensualControlador@postGMcapilla','class' => 'form-horizontal', 'role' => 'form', 'id'=>'empresa','files' => true)) }} 
                ...
                <div class="form-group" >
                  ...
                  <div class="form-group" id="div_monto4" >
                     ...
                     <div class="col-lg-10" align="right">
                            <label class="radio-inline" ><input type="radio" name="insercion4"  value="1" id="individual4" >Monto individual - Nuevo </label>
                            <label class="radio-inline"><input type="radio" name="insercion4" value="0" id="conjunto4">Montos en conjunto</label>
                     </div>
                     ...
                     <div  class="form-group" id="div_gasto_mtto_capilla2">

                              @foreach($gastos as $g)
                              @if($g->gasto_mtto_capilla == 1)
