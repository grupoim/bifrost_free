...
<div id="container" style="min-width: 310px; height: 400px; margin: 0 auto"></div>
         ...
         <!-- Empieza grafica ventas totales de febrero -->
         <div class="row">
          <div class="col-md-12">
          ...
          <!-- termina grafica ventas totales de febrero -->
          <!-- empieza grafica ventas totales  -->
         <div class="row">
          <div class="col-md-12">
        ...
        <!-- termina grafica ventas totales-->
        <!-- empieza grafica ventas totales columnas 2017 -->
         <div class="row">
          <div class="col-md-12">
        ...
        <!-- termina grafica ventas totales columnas 2017-->
        @show
      </div>
    </div>
...
<!-- script graficas ventas totales febrero -->
<script>
  Highcharts.chart('container1', {
    ...
    subtitle: {
        text: '{{{$mes}}}  {{{$serie2['name']}}}, {{{$serie1['name']}}} y {{{$serie['name']}}}'
    },
   xAxis: {
        categories: ['', '', ''],
        labels: {
...
<!-- script graficas ventas totales  -->
<script>
  ...
  Highcharts.chart('container2', {
    ...
    subtitle: {
        text: 'Años {{{$serie2['name']}}}, {{{$serie1['name']}}} y {{{$serie['name']}}}'
    },
    xAxis: {
    ...
    series: [{
       ...
       data: [ @foreach($serie2['ventastotales2'] as $d ) {{{round($d->monto,0)}}}, @endforeach ]
        ...
        data: [@foreach($serie1['ventastotales1'] as $d ) {{{round($d->monto,0)}}}, @endforeach ]
    },{
        name: '{{{$serie['name']}}}',
        marker: {
            symbol: 'diamond'
        },
        data: [@foreach($serie['ventastotales'] as $d ) {{{round($d->monto,0)}}}, @endforeach]
          
    }]
});
</script>
<!-- script graficas ventas totales 2017 -->
<script>
  Highcharts.chart('container3', {
    ...
    title: {
        text: 'Ventas totales {{{$mes}}} {{{$serie['name']}}} '
    },
    xAxis: {
          categories: ['Ene', 'Feb', 'Mar', 'Abr', 'May', 'Jun',
            'Jul', 'Agost', 'Sep', 'Oct', 'Nov', 'Dic']
    ...
    series: [{
        name: 'Servicios a previsión',
        data: [@foreach($serie['serviciosApre'] as $d ) {{{round($d->monto,0)}}}, @endforeach]
         
    }, {
        name: 'Recubrimiento',
        data: [@foreach($serie['recubrimiento'] as $d ) {{{round($d->monto,0)}}}, @endforeach]
    },{
        name: 'Mantenimiento',
        data: [@foreach($serie['mantenimiento'] as $d ) {{{round($d->monto,0)}}}, @endforeach]
    },
    {
        name: 'Gavetas',
        data: [@foreach($serie['gaveta'] as $d ) {{{round($d->monto,0)}}}, @endforeach]
    }, {
        name: 'Terrenos',
        data: [@foreach($serie['terreno'] as $d ) {{{round($d->monto,0)}}}, @endforeach]
    },
    {
        name: 'Nichos',
        data: [@foreach($serie['nicho'] as $d ) {{{round($d->monto,0)}}}, @endforeach]
    },
    {
        name: 'Extras',
        data: [@foreach($serie['extra'] as $d ) {{{round($d->monto,0)}}}, @endforeach]
    },
    {
        name: 'Exhumación',
        data: [@foreach($serie['exhumacion'] as $d ) {{{round($d->monto,0)}}}, @endforeach]
    },
    {
        name: 'Inhumación',
        data: [@foreach($serie['inhumacion'] as $d ) {{{round($d->monto,0)}}}, @endforeach]
    },
    {
        name: 'Cesión de derecho',
        data: [@foreach($serie['cesionD'] as $d ) {{{round($d->monto,0)}}}, @endforeach]
    }
