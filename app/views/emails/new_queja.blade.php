...
<body>
               ...
               <div >
                <p><h2>Nueva queja en Sistema Bifrost PFG </h2></p>
                     ...
                     {{{$rubro}}}</p>
                      ...
                      <strong><p><label>Descripcion:</label> </strong>
                   <i> <q>{{{$descripcion}}}</q></p></i>
                     </div>
          
         <p> <a style="background-color: #549DA3; font-family:Arial, sans-serif; border: medium none; border-radius: 6px;color: white;font-size: 14px;height: 15px; text-decoration:none;padding-top:7px; padding-bottom:7px; padding-left: 30px; padding-right:30px;" href="{{action('QuejaControlador@getRecupera', $queja_id)}}">Consulta detalles en Bifrost PFG</a> </p>
