              ...
              <div class="widget wred">
                ...
                <div class="widget-content">
                  <div class="padd">
                    ...
                    {{ Form::open(array('action' => 'InventarioRecubControlador@postAgregacolor', 'class' => 'form-horizontal', 'role' => 'form')) }} 

                   
                      <div class="form-group">
                                  <label class="col-lg-4 control-label">Color</label>                                  
                                  <div class="col-lg-4">
                                    <input type="text" class="form-control" placeholder="Nombre del color" name="nombre_color" required>
                                  </div>                                  
                                </div>
