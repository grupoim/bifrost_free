            ...
            function get_total(total,thisid){
                ...
                var thismeter = $('div[data-meter="'+thisid+'"]');
                   ...
                   thismeter.addClass('medium').html('Segura');
                     ...
                     thismeter.removeClass();
                   thismeter.addClass('strong').html('Muy Segura');
                }
                
                if (total == -1) { thismeter.removeClass().html('Seguridad de la Contraseña'); }
            }
